...
/*
Plugin Name: Easy Ad Widget
Plugin URI: https://github.com/FarzadRoozbahani/Easy-Ad-Widget
Author: FarzadRoozbahani
Author URI: http://farzadroozbahani.ir
...
class AdWidget_ImageWidget extends WP_Widget
{
     ...
     */
     ...
     function widget($args, $instance)
     {
        ...
        {
            echo "<a $target href='$link' alt='Ad'><img data-skip-lazy $resize_s src='$img' alt='Ad' /></a>";
        }
     ...
     function form($instance)
     {
       ...
       <p style="text-align: center;" class="bs-proof">
           <?php if($instance['w_img']): ?>
                ...
                <div class="bs-proof"><img data-skip-lazy style="width:100%;" src="<?php echo $instance['w_img'] ?>" alt="Ad" /></div><br/>
           <?php endif; ?>
